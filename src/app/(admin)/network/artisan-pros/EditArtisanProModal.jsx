...
export default function EditArtisanProModal({ data, onClose, onSuccess }) {
  ...
  const [form, setForm] = useState({
    ...
    estimated_production_m3_year:
      data.estimated_production_m3_year || "",

    real_production_last_year_m3:
      data.real_production_last_year_m3 || "",
  ...
  function updateVillage(index, key, value) {
    const arr = [...villages];
    arr[index][key] = value;
    setVillages(arr);
  }
