...
import AddKontikkiModal from "../../kontikkis/AddKontikkiModal";
...
export default function ArtisanProViewPage() {
  ...
  const [showAddKontikki, setShowAddKontikki] = useState(false);
...
async function handleDeleteKontikki(kontikkiId, kontikkiCode) {
  const confirmed = window.confirm(
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border rounded p-4 space-y-3">
        {data.artisan_pro_villages.length === 0 ? (
      ...
      <div className="space-y-3">
        ...
        <div className="flex justify-between items-center">
          ...
          <button
            onClick={() => setShowAddKontikki(true)}
      ...
      {showAddKontikki && (
          <AddKontikkiModal
            artisanProId={data.id}
            onClose={() => setShowAddKontikki(false)}
            onSuccess={() => {
              setShowAddKontikki(false);
              fetchData();
            }}
          />
        )}
